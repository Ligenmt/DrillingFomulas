 ...
 *
 */
public class DirectionalDrillingMenuFragment extends Fragment implements OnItemClickListener{
...
//	@ViewInject(R.id.tv_menu_title)
	...
	public void onActivityCreated(@Nullable Bundle savedInstanceState) {
		...
		tvMenuTitle.setText("定向井计算公式");
		List<String> nameList = new ArrayList<String>();
		itemNames = getResources().getStringArray(R.array.directional_drilling_formula);
...
//		ViewUtils.inject(this, rootView);
	...
	public void onItemClick(AdapterView<?> parent, View view, int position,
			long id) {
		Fragment f = FragmentFactory.getInstance().createFragmentFromTxt("directionaldrillingfrag.txt", position);
